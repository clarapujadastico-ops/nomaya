...
extension ImageResource {
    ...
    static let businessPlaceholder = ImageResource(name: "business_placeholder", bundle: resourceBundle)
    ...
    static let iconPmBankOutlined = ImageResource(name: "icon-pm-bank-outlined", bundle: resourceBundle)
    ...
    static let iconPmCardOutlined = ImageResource(name: "icon-pm-card-outlined", bundle: resourceBundle)
    ...
    static let iconPmCryto = ImageResource(name: "icon-pm-cryto", bundle: resourceBundle)

    /// The "icon-pm-cryto-outlined" asset catalog image resource.
    static let iconPmCrytoOutlined = ImageResource(name: "icon-pm-cryto-outlined", bundle: resourceBundle)
    ...
    static let iconEditOutline = ImageResource(name: "icon_edit_outline", bundle: resourceBundle)

    /// The "icon_edit_outlined" asset catalog image resource.
    static let iconEditOutlined = ImageResource(name: "icon_edit_outlined", bundle: resourceBundle)

    /// The "icon_info" asset catalog image resource.
    static let iconInfo = ImageResource(name: "icon_info", bundle: resourceBundle)
    ...
    static let iconLinkWarningCircle = ImageResource(name: "icon_link_warning_circle", bundle: resourceBundle)
    ...
    static let linkLogoTintable = ImageResource(name: "link_logo_tintable", bundle: resourceBundle)
    ...
    static let shoppayLogoBw = ImageResource(name: "shoppay_logo_bw", bundle: resourceBundle)
